...
export const cryptoOptions: CryptoOption[] = [
  {
    ...
    network: "Bitcoin (BTC)",
    explorerUrl: "https://www.blockchain.com/explorer/addresses/btc/bc1qds0szwvunhmj84yjseysavp8xdrt44vudfrej4"
  },
  {
    id: "bitcoin-cash",
    name: "Bitcoin Cash",
    ...
    explorerUrl: "https://www.blockchain.com/explorer/addresses/bch/qpq6mayr4ap9p6fn7fmhueudtk7fq4ejdvg8tg3d5t"
  },
  {
    id: "monero",
    name: "Monero",
    icon: <SiMonero size={24} />,
    address: "423ikTdokPG1179rMP1DTX78tTF8YoPcBgk7qaPtMQQnCX1ZmNXRe7RH3zDZUsmNfG7DiMTw86YuHGr3VXjTRSyjMKZCWKH",
    color: "bg-[#ff6600]",
  ...
  },
  {
    ...
    explorerUrl: "https://blockchair.com/litecoin/address/ltc1qqz7nh9xttk0wn30c2qz7cmadtpddkh8v8z8fc0"
  },
  {
    id: "usdt",
    name: "USDT ERC20",
