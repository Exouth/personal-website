  ...
  return (
    <>
      ...
      <main className="w-full flex-grow flex flex-col pt-16">
        <section className={`${sectionPadding} bg-gray-900/30 flex-grow`} aria-label="Legal Notice">
          <div className={`container mx-auto ${containerPadding} h-full`}>
            <motion.div {...fadeInUp(0.1)} className="max-w-4xl mx-auto h-full flex flex-col">
              ...
              <div className="space-y-8 flex-grow">
                ...
                <div>
                  ...
                  <p className="mb-3">
                    This website contains links to external websites. As the contents of these
                    websites are not under our control, we cannot assume any liability for such
